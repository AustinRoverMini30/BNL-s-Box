                            ...
                            if mouse_stat[0]:
                                ...
                                if pos_tello_connexion.collidepoint(event.pos) and not(tello_sys.connexion):
                                    ...
                                    if os.stat("Tello_log.txt").st_size == 0:
                                        Tello_log.write("________  __     __  __      ___     ________      _____      __  __" + "\n")
                                        Tello_log.write("| |     \ | |\   | | | |    /___/    | |     \    / ___ \     \ \/ /." + "\n")
                                        Tello_log.write("| |     | | | \  | | | |             | |     |   / /   \ \     \ \/.  " + "\n")
                                        Tello_log.write("| |_____/ | |\ \ | | | |             | |_____/  / /     \ \     \ \. " + "\n")
                                        Tello_log.write("| |     \ | | \ \| | | |             | |     \  \ \     / /    / \ \." + "\n")
                                        Tello_log.write("| |     | | |  \   | | |____         | |     |   \ \___/ /    / / \ \." + "\n")
                                        Tello_log.write("|_|_____/ |_|   \__| |______|        |_|_____/    \_____/    /_/   \_\." + "\n")
                                        Tello_log.write("\n")    
