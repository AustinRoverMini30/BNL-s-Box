...
def Menu_principal():
    ...
    while Menu_principal_actif==True:
        ...
        if changement==True:
            ...
            pygame.draw.rect(fenêtre,(0,150,255),pygame.Rect(20,-30+70*selection,260,60))
    ...
    while Menu_puissance==True:
        for event in pygame.event.get():
            ...
            if changement==True:
                ...
                if selection2==1:
                    pygame.draw.rect(fenêtre,(0,150,255),pygame.Rect(280,230,140,140))
                    pygame.draw.rect(fenêtre,(0,0,0),pygame.Rect(285,235,130,130))
                    joueur=1
                elif selection2==2:
                    pygame.draw.rect(fenêtre,(0,150,255),pygame.Rect(530,230,140,140))
                    pygame.draw.rect(fenêtre,(0,0,0),pygame.Rect(535,235,130,130))
                    joueur=2
                if selection==1:
                    pygame.draw.rect(fenêtre,(0,150,255),pygame.Rect(300,400,370,80))
                    pygame.draw.rect(fenêtre,(0,0,0),pygame.Rect(305,405,360,70))
                elif selection==2:
                    pygame.draw.rect(fenêtre,(0,150,255),pygame.Rect(360,550,260,80))
                    pygame.draw.rect(fenêtre,(0,0,0),pygame.Rect(365,555,250,70))
                pygame.draw.circle(fenêtre,(255,0,0), (350,300),50,0)
                pygame.draw.circle(fenêtre,(255,255,0), (600,300),50,0)
                fenêtre.blit(t2,(320,400))
                fenêtre.blit(t3,(380,550))
                pygame.display.flip()
    m1,m2=0,0
            ...
            if changement_puissance==True:
                    ...
                    for i in range(6):
                     for j in range(7):
                            if grille[i][j]==0:
                                ...
                                pygame.draw.circle(fenêtre,(255,0,0), (120+j*120,70+i*120),50,0)
                            elif grille[i][j]==5:
                                pygame.draw.circle(fenêtre,(255,255,0), (120+j*120,70+i*120),50,0)
                b=emplacements[case]
                if b!=-1:
                    pygame.draw.circle(fenêtre,(0,150,255), (120+case*120,70+b*120),25,0)
                else:
                    c=True
                    d=0
                    while c==True:
                ...
                if fin==True:
                    ...
                    if victoire==1:
                        ...
                        pygame.draw.circle(fenêtre,(255,0,0), (480,370),50,0)
                    elif victoire==2:
                        fenêtre.blit(t4,(350,150))
                        fenêtre.blit(t5,(320,200))
                        fenêtre.blit(v2,(600,200))
                        pygame.draw.circle(fenêtre,(255,255,0), (480,370),50,0)
                    elif victoire==3:
